...
NSString *const kICFashionKey = @"fashion";
NSString *const kICArtKey = @"art";
NSString *const kICEnergyKey = @"energy";
NSString *const kICEconomicsKey = @"economics";
NSString *const kICEntrepreneurKey = @"entrepreneur";
NSString *const kICBooksKey = @"books";
NSString *const kICPoliticsKey = @"politics";
NSString *const kICGardeningKey = @"gardening";
NSString *const kICNbaKey = @"nba";
NSString *const kICTechnologyKey = @"technology";
NSString *const kICStartupsKey = @"startups";
NSString *const kICRelationshipsKey = @"relationships";
NSString *const kICEducationKey = @"education";
NSString *const kICHumorKey = @"humor";
NSString *const kICPsychologyKey = @"psychology";
NSString *const kICBicyclingKey = @"bicycling";
NSString *const kICInvestingKey = @"investing";
NSString *const kICTravelKey = @"travel";
NSString *const kICCookingKey = @"cooking";
NSString *const kICChristianityKey = @"christianity";
NSString *const kICEnvironmentKey = @"environment";
NSString *const kICReligionKey = @"religion";
NSString *const kICHealthKey = @"health";
NSString *const kICHockeyKey = @"hockey";
NSString *const kICPetsKey = @"pets";
NSString *const kICMusicKey = @"music";
NSString *const kICSoccerKey = @"soccer";
NSString *const kICGunsKey = @"guns";
NSString *const kICGamingKey = @"gaming";
NSString *const kICJobsKey = @"jobs";
NSString *const kICBusinessKey = @"business";
NSString *const kICNatureKey = @"nature";
NSString *const kICFoodKey = @"food";
NSString *const kICCarsKey = @"cars";
NSString *const kICPhotographyKey = @"photography";
NSString *const kICPhilosophyKey = @"philosophy";
NSString *const kICGeekKey = @"geek";
NSString *const kICSportsKey = @"sports";
NSString *const kICBaseballKey = @"baseball";
NSString *const kICNewsKey = @"news";
NSString *const kICTelevisionKey = @"television";
NSString *const kICEntertainmentKey = @"entertainment";
NSString *const kICParentingKey = @"parenting";
NSString *const kICComicsKey = @"comics";
NSString *const kICScienceKey = @"science";
NSString *const kICNflKey = @"nfl";
NSString *const kICProgrammingKey = @"programming";
NSString *const kICPersonalfinanceKey = @"personalfinance";
NSString *const kICAtheismKey = @"atheism";
NSString *const kICMoviesKey = @"movies";
NSString *const kICAnimeKey = @"anime";
NSString *const kICFitnessKey = @"fitness";
NSString *const kICMilitaryKey = @"military";
NSString *const kICRealestateKey = @"realestate";
NSString *const kICHistoryKey = @"history";
